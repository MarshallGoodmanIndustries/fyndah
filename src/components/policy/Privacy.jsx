...
const Privacy = () => {
  ...
  return (
    <section className="w-full p-6 relative">
        <h1 className="font-poppins font-bold font-lg text-2xl lg:text-3xl sm:text-center text-accent capitalize">Privacy policy</h1>
        {privacy?.map(({numbering, title, desc},index)=>(
