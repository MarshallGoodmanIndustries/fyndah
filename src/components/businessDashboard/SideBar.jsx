    ...
    <>
      <div className="px-[1rem] text-white font-inter py-[1rem]">
        ...
        <Link to="leads">
          <div
            onClick={() => {
              handleToggle, handleItemClick(2);
            }}
        ...
        <Link to={`/businessDashboard/${id}/${name}/search-request`}>
          <div
            ...
            className={`flex cursor-pointer mb-1 hover:bg-white rounded-[4px] hover:text-textDark px-[1rem] py-[0.5rem] items-center justify-start gap-4 ${isItemActive(9) ? "bg-white text-textDark" : "text-white"
              } `}
          >
            <span>
              <AiFillMessage className="size-[1rem] lg:size-[1.25rem]" />
