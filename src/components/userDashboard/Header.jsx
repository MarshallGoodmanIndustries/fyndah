    ...
    <div className='text-white relative sm:px-[2rem] px-[1rem] items-center h-full flex justify-between z-20 font-inter'>
      ...
      <div className='flex items-center justify-end md:gap-[1.8rem] gap-[1rem] lg:col-span-3 xl:col-span-2 col-span-2'>
        <span className='relative cursor-pointer'>
          ...
          <p className='absolute top-[-5px] left-2 text-white rounded-full bg-textDark px-1 text-[11px]'>
            {' '}
            {notificationNumber}{' '}
          </p>
        </span>
        <div className='flex gap-3 items-center'>
          <span className='bg-textDark align-middle md:text-[1rem] text-[0.65rem] py-1 px-2 rounded-[50%] font-semibold text-white'>
            {userInitials}
          </span>
